...
}: { handle: string, gated: GateData, creatorLensProfileId: string, lensPubId: string, refetchMeetsGatedCondition: () => void }) => {
      ...
      <div className="min-h-full px-4 py-16 sm:px-6 sm:py-24 md:grid lg:px-8 md:place-items-center">
        <div className="mx-auto max-w-max">
          <div className="sm:border-l sm:border-gray-200 sm:pl-6">
            <h1 className="animate-move-txt-bg gradient-txt text-4xl font-bold tracking-tight sm:text-5xl">ClubSpace Is Token-Gated</h1>
          ...
          <div className="md:items-center md:justify-center mt-8">
            ...
            {isConnected && !(lensLoginData || lensRefreshData) && (
              <div className="w-60 mx-auto">
                <button onClick={_loginWithLens} className="relative btn btn-lens h-[45px] btn justify-center items-center overflow-hidden">
