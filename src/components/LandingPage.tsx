...
const Sequence = [
  {
    id: 1,
    title: "Create Space",
    image: "https://tailwindui.com/img/component-images/mobile-app-screenshot.png",
  },
  {
    id: 2,
    title: "Promote your drop",
    image: "https://tailwindui.com/img/component-images/mobile-app-screenshot.png",
  },
  {
    id: 3,
    title: "Connect on decentralized social",
    image: "https://tailwindui.com/img/component-images/mobile-app-screenshot.png",
  },
  {
    id: 4,
      ...
      <main>
        ...
        <div className="mt-32 sm:mt-56 sm:px-6 lg:px-8">
          ...
          <div className="mt-32 mx-auto px-6 lg:px-8 flex items-center gap-48 lg:ml-32 flex-wrap">
            {Sequence.map((item) => (
              <div key={item.id} className="flex items-center flex-col gap-4">
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-center lg:gap-y-0">
              <div className="lg:row-start-2 lg:max-w-md">
                <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">
                  Create a Space
                  <br />
                  Or Promote your drop
                </h2>
                <p className="mt-6 text-lg leading-8 text-gray-300">
                  ClubSpace is a web3-based platform that empowers musicians to seamlessly promote, monetize, and
