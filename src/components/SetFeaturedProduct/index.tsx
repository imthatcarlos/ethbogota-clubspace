                ...
                <>
                  <div className="flex flex w-full justify-center relative grid-cols-2 gap-4">
                    ...
                    >
                      ...
                      <label htmlFor="radio-protocol-decent" className="w-full py-4 ml-2 text-sm font-medium text-black cursor-pointer">Decent</label>
                    </div>
                    <div
                      className="flex w-full items-center pl-4 border border-gray-200 rounded bg-white cursor-pointer"
                    ...
                    >
                      ...
                      <label htmlFor="radio-protocol-sound" className="w-full py-4 ml-2 text-sm font-medium text-black cursor-pointer">Sound</label>
                    </div>
                  </div>
                </>
              )
